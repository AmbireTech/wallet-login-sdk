...
var sdkCore = function sdkCore(opt) {
  var _opt$dappName, _opt$dappIconPath, _opt$wrapperElementId;
  if (opt === void 0) {
    opt = {};
  }
  var self = this;
  ...
  this.iframe = null;
  this.initSdkWrapperDiv = function (id) {
    if (id === void 0) {
  ...
  this.openLogin = function (chainInfo) {
    if (chainInfo === void 0) {
      chainInfo = null;
    }
  ...
  this.onMessage = function (messageType, sdkCallback, clientCallback) {
    if (clientCallback === void 0) {
...
function AmbireWalletModule(sdkParams) {
  var ambireSDK = new sdkCore(sdkParams);
